    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>工作室列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-table :data="userList" border style="width: 100%" ref="multipleTable"
            ...
            <el-table-column prop="id" label="工作室ID" width="100">
            </el-table-column>
           ...
           <!-- <el-table-column prop="groupName" label="类型" :show-overflow-tooltip="true">
            ...
            <el-table-column prop="categoryNames" label="类别" :show-overflow-tooltip="true">
            </el-table-column>
        ...
        <!--弹窗modal-->
        <el-dialog title="工作室添加/编辑" :visible.sync="dialogFormVisible" size="small">
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    <el-col :span="8" >
                        <div class="grid-content form_label">工作室昵称:</div>
                    </el-col>
                    <el-col :span="16">
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="16">
                        <el-input :rows="4" type="textarea" v-model="studioIntro" placeholder="请输入工作室简介"></el-input>
            ...
            <!--<el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="10">
                        <div class="change">
                            <upload showtype="2" :title="title2" v-on:uploadSuccess="stuImgUrl"
...
-->
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="10">
                        <div class="change">
                            <upload showtype="2" :title="title" v-on:uploadSuccess="stuImgUrl"></upload>
                        </div>
                    </el-col>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="10">
                        ...
                        <div class="change">
                            <upload showtype="2" :title="title2" v-on:uploadSuccess="stuBgimgUrl"
                                    style="width: 600px;height: 150px;overflow: hidden"></upload>
                        </div>
                    </el-col>
                </el-col>
      ...
      watch: {
        ...
        methods : {
          ...
          doadd(){
              ...
              if(undefined == this.studioIntro || '' == this.studioIntro){
                  this.$message('简介不可为空');
                  return;
              }
          ...
          showedit(index,row){
            ...
            this.$axios({
              ...
              .then((res) => {
                ...
                this.studioIntro = res.data.body.intro;
