    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>圈层机构列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-table :data="userList" border style="width: 100%" ref="multipleTable"
            ...
            <el-table-column prop="id" label="圈层机构ID" width="110">
            </el-table-column>
            <el-table-column prop="name" label="名称" :show-overflow-tooltip="true" width="100">
            </el-table-column>
            <el-table-column prop="groupName" label="类型" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="categoryName" label="类别" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="createDate" label="加入时间" :show-overflow-tooltip="true" width="100">
            </el-table-column>
            <el-table-column prop="scriptCount" label="版权数" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="demandCount" label="需求数" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="beforeCount" label="项目数" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="videoCount" label="视频数" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="receiveCount" label="承接数" :show-overflow-tooltip="true">
            </el-table-column>
        ...
        <!--弹窗modal-->
        <el-dialog title="圈层机构添加/编辑" :visible.sync="dialogFormVisible" size="small">
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    <el-col :span="8">
                        <div class="grid-content form_label">圈层机构昵称:</div>
                    </el-col>
                    <el-col :span="16">
                ...
                <el-col :span="12" :offset="6">
                    <el-col :span="24" :offset="6">
                        <el-checkbox-group v-model="checklist">
                            <el-checkbox v-for="item in sellTypeList" :label="item.id" :key="item.name">{{item.name}}</el-checkbox>
                        </el-checkbox-group>
                    </el-col>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    <el-col :span="5">
                        <div class="grid-content ">公司成员：</div>
                    </el-col>
                    <el-col :span="8" :offset="3">
                        <el-button type="primary"  class="handle-del mr10" @click="showGetUser">选择公司成员</el-button>
                    ...
                    <el-col :span="8">
                        ...
                        <showUser :dialogFormVisible.sync="isdisplayUsers" :keyName="keyName" :needShowUserArr="companyUsers" @selted="closeShowUser" @delUeritem="deleteUser"></showUser>
                    </el-col>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="16">
                        <el-input :rows="4" type="textarea" v-model="companyIntro" placeholder="请输入圈层机构简介"></el-input>
            ...
            <!--<el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="10">
                        <div class="change">
                            <upload showtype="2" :title="title2" v-on:uploadSuccess="comImgUrl"
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="10">
                        <div class="change">
                            <upload showtype="2" :title="title" v-on:uploadSuccess="comImgUrl"></upload>
                        </div>
                    </el-col>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="15">
                <el-col :span="12" :offset="6">
                    ...
                    <el-col :span="10">
                        <div class="change">
                            <upload showtype="2" :title="title2" v-on:uploadSuccess="comBgimgUrl"
                                    style="width: 600px;height: 150px;overflow: hidden"></upload>
                        </div>
                    </el-col>
  ...
  export default {
    ...
    methods: {
      ...
      doadd() {
          ...
          if(undefined == this.companyIntro || '' == this.companyIntro){
              this.$message('简介不可为空');
              return;
          }
        ...
        self.companyUserIds = '';
        for (var i = 0; i < self.companyUsers.length; i++) {
          var obj = self.companyUsers[i];
          self.companyUserIds+=obj.userId+",";
        }
        ...
        if (self.idEdit) {
         /* var categoryidsstr = '';
          ...
          this.$axios({
            ...
            data : {
              userIds:this.companyUserIds,//圈层机构成员id
              userId:self.add_user_id,
              name: self.add_name,
              oneWord: self.add_simpleintro,
              intro: self.companyIntro,
              fans: this.add_fans,
      ...
      showedit(index, row) {
        ...
        this.title = '修改头像',
          this.title2 = '修改背景图',
          localStorage.setItem('cid', row.id);
        this.$axios({
          method: 'get',
          ...
          .then((res) => {
            ...
            this.type01_add = res.data.body.groupName;
            this.type02_add = res.data.body.categoryName;
            this.add_name = res.data.body.name;
            this.add_simpleintro = res.data.body.oneWord;
            this.companyIntro = res.data.body.intro;
            ...
            this.add_userId = res.data.body.userId;
            this.members = res.data.body.members;
            ...
            for (var i = 0; i < this.members.length; i++) {
              ...
              this.demandRecName = obj.userNickName;
...
//            }
      ...
      updateSort() {
        ...
        for (var i = 0; i < this.sellTypeList.length; i++) {
          ...
          if (this.type01_add == obj.id) {
            this.sortTypeList = obj.subs;

            if (this.sortTypeList == undefined) {
              this.type02_add = '';
            } else {
              this.type02_add = this.sortTypeList[0].id;
            }
            break;
          }
      ...
      deleteUser(obj){
        this.companyUsers.splice(this.companyUsers.indexOf(obj), 1);
      },
