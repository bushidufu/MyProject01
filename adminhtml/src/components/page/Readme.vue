    ...
    <div>
        ...
        <div class="ms-doc">
            ...
            <article>
                ...
                <editlist :editEnable='false' :candrag='true' :ratio="'3:5'" :defaultSize="2.5"></editlist>
                <editlist :editEnable='true' :candrag='true' :ratio="'4:5'" :defaultSize="3.5"></editlist>
            </article>
        </div>
  ...
  export default {
    data: function () {
      return {
        ...
        isdisplayPub: false,
        arr: [{id: 1, name: 'name1'}, {id: 2, name: 'name2'}, {id: 3, name: 'name3'}, {id: 4, name: 'name4'}, {id: 5, name: 'name5'}, {id: 6, name: 'name6'}],
      }
    },
    methods: {
      showPubUser() {
